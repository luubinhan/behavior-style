<template>
  <article>
    <Heading>Steadiness</Heading>

    <div class="mb-6">
      <div class="bg-blue-500 p-2 rounded mb-2">
        Interested in, and places high value, on personal relationships,
        feelings, human interactions, and affiliation with others.
      </div>
      <div class="bg-blue-500 p-2 rounded mb-2">
        Warm and sensitive to the feelings of others.
      </div>
      <div class="bg-blue-500 p-2 rounded mb-2">
        Perceptive, able to assess a situation in terms of the human emotions
        involved.
      </div>
      <div class="bg-blue-500 p-2 rounded mb-2">Loyal and supportive.</div>
    </div>
    <div class="mb-6">
    ...
    <div class="grid grid-cols-3 gap-6 <md:grid-cols-1">
      <div class="rounded-2xl bg-violet-400 p-4">
        ...
        <div class="font-light">Security</div>
      </div>
      <div class="rounded-2xl bg-violet-400 p-4">
        <div class="flex align-center justify-center">
          <div
        ...
        <div class="font-light">Insecurity</div>
      </div>
      <div class="rounded-2xl bg-violet-400 p-4">
        <div class="flex align-center justify-center">
          <div
        ...
        <div class="font-light">Service and support. A specialist.</div>
      </div>
    </div>
