<template>
    <article>
      ...
      <div class="mb-6">
        ...
        <div class="bg-blue-500 p-2 rounded mb-2">Can feel personally let down by people and left out.</div>
      </div>
      <div class="mb-6">
      ...
      <div class="grid grid-cols-3 gap-6">
        <div class="rounded-2xl bg-violet-400 p-4">
          ...
          <div class="font-light">Public praise and recognition</div>
        </div>
        <div class="rounded-2xl bg-violet-400 p-4">
          <div class="flex align-center justify-center">
            <div
          ...
          <div class="font-light">Rejection</div>
        </div>
        <div class="rounded-2xl bg-violet-400 p-4">
          <div class="flex align-center justify-center">
            <div
          ...
          <div class="font-light">Working with and through people.</div>
        </div>
      </div>
  ...
  export default {
    ...
    data: () => ({
      ...
      observable: [
        ...
        {
          label: "Office",
          value: "Certificates, pictures, trophies, newspaper clippings relating to themselves on display.",
        },
        {
          label: "Dress",
          value: "May be dressed in the latest fashion; colour coordinated and may dress to impress.",
        },
        {
          label: "Manners",
          value: "Could appear superficial and impulsive; happy to share their feelings.",
        },
        {
          label: "Eye contact",
        ...
        },
        {
          label: "Body Language",
          value:
            "Animated hand and body movement.",
        },
        {
          label: "Handling disagreements",
          value: "Prefers to persuade rather than confront aggressively or demand.",
        },
      ],
      communication: [
        {
